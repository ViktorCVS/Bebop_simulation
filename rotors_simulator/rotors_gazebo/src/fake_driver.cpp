...
void traj_callback(const trajectory_msgs::MultiDOFJointTrajectoryConstPtr& trajectory_reference_msg);
...
void odom_callback(const nav_msgs::OdometryConstPtr& msg){
 ...
 //   return;
  ...
  double roll = linear_y * axis_direction_roll/3;
  double pitch  = linear_x  * axis_direction_pitch/3;
  double thrust  = linear_z  * axis_direction_thrust/3;
  double yaw  = angular_z  * axis_direction_yaw*3/2*1/0.99;
